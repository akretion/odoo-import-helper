...
class ProductImportHelper(TransactionCase):
    ...
    def test_product_import(self):
        ...
        self.assertEqual(product.orderpoint_ids[0].product_min_qty, vals['orderpoint_min_qty'])
        self.assertEqual(product.orderpoint_ids[0].product_max_qty, vals['orderpoint_max_qty'])
